...
def work(app):
    schedule.every().minute.at(":00").do(interval_job_1m, app=app, symbol=config["Symbol"],
                                         interval=config["Interval_1"], is_queue=False)
    schedule.every().minute.at(":00").do(interval_job_15m, app=app, symbol=config["Symbol"],
                                         interval=config["Interval_2"], is_queue=False)
    schedule.every().hour.at("00:00").do(interval_job_1h, app=app, symbol=config["Symbol"],
                                         interval=config["Interval_3"], is_queue=False)
    schedule.every().hour.at("00:00").do(interval_job_4h, app=app, symbol=config["Symbol"],
                                         interval=config["Interval_4"], is_queue=False)
    schedule.every().day.at("00:00:00").do(interval_job_1d, app=app, symbol=config["Symbol"],
                                           interval=config["Interval_5"], is_queue=False)
...
from Routes.queue_routes import user_list
